    ...
    <section className="auth-form">
        ...
        <Link href="/" className="cursor-pointer items-center gap-1 flex"> 
            <Image 
                ...
                alt="BankLogo"
            />
            <h1 className="text-26 font-ibm-plex-serif font-bold text-black-1">BankProj</h1>
        </Link>
                ...
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                    ...
                    {type === 'sign-up' && (
                        ...
                        <div className="flex gap-4">
                            <CustomInput control={form.control} name="firstName" label= "First Name" placeholder="Enter your fist name"/>
